        ...
        <div>
          {(activeTab === "upcoming" ? upcomingReservations : pastReservations)
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-500 text-sm">
                      {reservation.serviceType === "FULL"
                        ? "목욕 + 커트"
                        : reservation.serviceType === "WASH"
                        ? "목욕"
                        : reservation.serviceType === "CUT"
                        ? "커트"
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm">
                              {{
                                ...
                                MALTESE: "말티즈",
                              }[reservation.breedType] || reservation.breedType}
                            </span>
                          </div>
                        </div>
                      </div>
            ...
            <div className="text-center py-12">
              ...
              <button
                className="mt-4 px-4 py-2 bg-pink-500 text-white rounded-full hover:bg-pink-600 transition-colors shadow-sm"
                onClick={() => navigate("/mungshop")}
              >
                새로운 예약하기
              </button>
            </div>
