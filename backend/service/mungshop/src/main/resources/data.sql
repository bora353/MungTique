...
VALUES ('GOLDEN_RETRIEVER', 'Basic grooming', 50000, 1),
       ...
       ('FRENCH_BULLDOG', 'Basic grooming', 55000, 3),
       ('FRENCH_BULLDOG', 'Full grooming', 90000, 3),
       ('POMERANIAN', 'Basic grooming', 40000, 4),
       ('POMERANIAN', 'Full grooming', 70000, 4),
       ('SIBERIAN_HUSKY', 'Basic grooming', 60000, 4),
       ('SIBERIAN_HUSKY', 'Full grooming', 95000, 4);
