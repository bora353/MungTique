INSERT INTO mung_shop (store_name, store_address, breeds, business_hours, closing_days, latitude, longitude, file_path)
VALUES
...
INSERT INTO mymung (mung_name, breed, weight, age, gender, fixed, user_id)
VALUES
    ('싼쵸', '치와와', 4, 5, '수컷', 'Yes', 1),
    ('코코', '말티푸', 2, 1, '암컷', 'No', 1);

INSERT INTO mung_shop_price (breeds, service_type, price, mung_shop_id)
